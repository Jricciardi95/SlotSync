...
type Props = NativeStackScreenProps<ModesStackParamList, 'ReorganizeModeStart'>;

type OrganizationRule = 'title' | 'artist' | 'artistLastName' | 'year';

export const ReorganizeModeStartScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleStart = () => {
    ...
    navigation.navigate('ReorganizeModeFlow', {
  ...
  return (
    <AppScreen
      title="Reorganize Mode"
      subtitle="Reorder your collection with minimal swaps, guided by LEDs."
    >
      <ScrollView>
        <AppCard>
